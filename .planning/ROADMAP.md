...
- [ ] 05-05-PLAN.md — Make the locked-account and wrong-code failures at `@@reset-bar-code` emit the same assembled status message, plus the anonymous equality test the 05-03 substring criterion could not catch (MFA-08)
...
| 5. Drift, Replay and Lockout | 4/4 | In Progress|  |
