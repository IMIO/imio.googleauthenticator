...
- [ ] **Phase 1: Rename and Fail-Closed** - `imio.googleauthenticator` everywhere, and a plugin exception becomes a 500 instead of a password-only login
...
|-------|----------------|--------|-----------|
| 1. Rename and Fail-Closed | 4/4 | In Progress|  |
