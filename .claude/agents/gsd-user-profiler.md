...
<reference>
@/srv/src/imio.googleauthenticator/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/srv/src/imio.googleauthenticator/.claude/gsd-core/references/user-profiling.md` to load:
