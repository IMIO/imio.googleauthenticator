...
**Verification depth scales with `asvs_level`** (see @/srv/src/imio.googleauthenticator/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
