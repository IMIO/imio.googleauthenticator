...
Reference full template: `/srv/src/imio.googleauthenticator/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/srv/src/imio.googleauthenticator/.claude/gsd-core/templates/state.md`.
