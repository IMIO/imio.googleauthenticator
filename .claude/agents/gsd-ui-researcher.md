...
Use template from `/srv/src/imio.googleauthenticator/.claude/gsd-core/templates/UI-SPEC.md`.
...
Read template: `/srv/src/imio.googleauthenticator/.claude/gsd-core/templates/UI-SPEC.md`
