...
<execution_context>
@/srv/src/imio.googleauthenticator/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow /srv/src/imio.googleauthenticator/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
