...
- @/srv/src/imio.googleauthenticator/.claude/gsd-core/workflows/complete-milestone.md (main workflow)
- @/srv/src/imio.googleauthenticator/.claude/gsd-core/templates/milestone-archive.md (archive template)
  </execution_context>
