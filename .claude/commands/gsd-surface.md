...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/srv/src/imio.googleauthenticator/.claude/.gsd-surface.json`
(sibling to `/srv/src/imio.googleauthenticator/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/srv/src/imio.googleauthenticator/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/srv/src/imio.googleauthenticator/.claude/skills`).
...
`/srv/src/imio.googleauthenticator/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/srv/src/imio.googleauthenticator/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/srv/src/imio.googleauthenticator/.claude/.gsd-surface.json`
Install profile marker: `/srv/src/imio.googleauthenticator/.claude/.gsd-profile`
Skill dirs: `/srv/src/imio.googleauthenticator/.claude/skills/gsd-*/`
Engine module: `/srv/src/imio.googleauthenticator/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/srv/src/imio.googleauthenticator/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
