...
<execution_context>
@/srv/src/imio.googleauthenticator/.claude/gsd-core/workflows/manager.md
...
Read and execute `/srv/src/imio.googleauthenticator/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
